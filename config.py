...
def load_config(yaml_path: str, overrides: dict = None) -> 'Config':
    ...
    Example:
        ...
        cfg = load_config('configs/base.yaml',
                          overrides={'training.num_epochs': '200'})
    """
    ...
    line_sec = raw.get('line_params', {})  # NEW: line parameters section
    ...
    cfg = Config(
        ...
        NORMALIZATION_MODE = data_sec.get('normalization_mode', 'standard'),  # NEW

        # line parameters (NEW section)
        ...
        # scheduler
        SCHEDULER_TYPE = sched_sec.get('type', 'cosine'),
