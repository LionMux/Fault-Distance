"""
⚠️  УСТАРЕВШИЙ TUTORIAL — НЕ ИСПОЛЬЗОВАТЬ БЕЗ ПРОВЕРКИ

Этот файл создан ранее и содержит устаревшие параметры
(seq_length=300, старые импорты API). Перед запуском обновите
константы под текущий config.py (SEQ_LENGTH=1000 и т.д.).

Если вам нужен рабочий пример — смотрите scripts/augment_and_train.py
или запускайте train.py напрямую.
"""
